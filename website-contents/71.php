...
")) {
	while ($row = $r->fetch_assoc()) {
		if (!isset($arrout[$row['lsc_id']])) {
			$arrout[$row['lsc_id']] = array($row['lsc_name'], array(), array());
		}
		if (!isset($arrout[$row['lsc_id']][1][$row['grpdate']])) {
			$arrout[$row['lsc_id']][1][$row['grpdate']] = array();
		}
		if (!isset($arrout[$row['lsc_id']][2][$row['prt_id']])) {
			$arrout[$row['lsc_id']][2][$row['prt_id']] = $row['prt_name'];
		}
		$colorlist = array();
		...
		if (!isset($arrout[$row['lsc_id']][3][$row['prt_id']])) {
			$arrout[$row['lsc_id']][3][$row['prt_id']] = implode(",", $colorlist);
		}
