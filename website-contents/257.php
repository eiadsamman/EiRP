...
<style type="text/css">
	.l{
		position:relative;font-size: 0.8em;top:3px
	}
		...
		<tr>
			<td style="min-width: 300px;width:100%" valign="top" class="tcell">
				<?php
					...
					if($tables->Permissions(258,$USER->info->permissions)->read){
						echo "<a href=\"".$tables->pagefile_info(258,null)['directory']."\" style=\"color:#000\" target=\"_blank\">Materials manager</a>";
					}
				...
				<table class="bom-table main">
					<tbody>
						<tr>
							...
							<td class="btn-set">
								<select id="js-input-material" style="width:100%">
									<?php
										$rmat= $sql->query("SELECT cndmat_id,cndmat_name,cndmat_young,cndmat_creep FROM candas_materials ");
										if($rmat){
											while($rowmat = $sql->fetch_assoc($rmat)){
						...
						<tr>
							...
							<td>E</td>
							<td><div class="btn-set"><input class="flex" id="js-outout-youngmodulus" readonly type="text"><span>MPa</span></div></td>
						</tr>
						<tr>
							<td>Standard Dimensions Ratio</td>
							<td>SDR</td>
							<td><div class="btn-set"><input data-error="err61" class="flex" id="js-input-sdr" type="text" value="11"><span>D/s</span></div>
								<span class="input-error" id="err61">Invalid SDR value, accepted range (1~100)</span></td>
						</tr>
						<tr>
							<td>Creep modulus</td>
							<td>c</td>
							<td><div class="btn-set"><input class="flex" id="js-outout-creepmod" readonly type="text"></div></td>
						</tr>
						<tr>
							<td>Nominal ring stiffness</td>
							<td>SN</td>
							<td><div class="btn-set"><input class="flex" id="js-output-nomringstiff" readonly type="text"><span>KPa</span></div></td>
						</tr>
						<tr>
							<td>Long term young modulus</td>
							<td>E0</td>
							<td><div class="btn-set"><input class="flex" id="js-outout-longtermyoungmod" readonly type="text"><span>MPa</span></div></td>
						</tr>
						<tr>
							<td>Long term stiffness</td>
							<td>SN<span class="l">0</span></td>
							<td><div class="btn-set"><input class="flex" id="js-outout-longtermstiff" readonly type="text"><span>KPa</span></div></td>
						</tr>
					</tbody>
				</table>
				<?php
				...
				<table class="bom-table main">
					<tbody>
						<tr>
							...
							<td><div class="btn-set"><input class="flex" data-error="err95" id="js-input-load" type="text" value="1200"><span>N</span></div>
								<span class="input-error" id="err95">Invalid Load value, accepted range (1~10000)N</span></td>
						</tr>
						...
						<tr>
							<td>Sample length</td>
							<td>L</td>
							<td><div class="btn-set"><input class="flex" data-error="err103" id="js-input-samplelength" type="text" value="300"><span>mm</span></div>
								<span class="input-error" id="err103">Invalid Sample length, accepted range (1~10000)N</span></td>
						</tr>
						
						<tr>
							<td>Pipe internal diameter</td>
							<td>Di</td>
							<td><div class="btn-set"><input class="flex" data-error="err110" id="js-input-internaldim" type="text" value="135"><span>mm</span></div>
								<span class="input-error" id="err110">Invalid diameter, accepted range (1~10000)N</span></td>
						</tr>
						
						<tr>
							<td>Nominal ring stiffness</td>
							<td>SN</td>
							<td><div class="btn-set"><input class="flex" id="js-output-sSN" readonly type="text"><span>KPa</span></div></td>
						</tr>
...
<script type="text/javascript">
	...
	let DOMFields = {
		input:{
			material:{class:"option", obj: document.getElementById("js-input-material"), val:[0,0] },
			sdr			:{class:"input", obj: document.getElementById("js-input-sdr"), val:false, translate:[(v)=>parseFloat(v), 1,100]},
			load		:{class:"input", obj: document.getElementById("js-input-load"), val:false, translate:[(v)=>parseFloat(v), 1,10000]},
			samplelength:{class:"input", obj: document.getElementById("js-input-samplelength"), val:false, translate:[(v)=>parseFloat(v), 1,10000]},
			internaldim	:{class:"input", obj: document.getElementById("js-input-internaldim"), val:false, translate:[(v)=>parseFloat(v), 1,10000]},
		},
		output:{
			youngModulus:{class:"input", obj: document.getElementById("js-outout-youngmodulus"), val:false},
			nominalRingStiffness:{class:"input", obj: document.getElementById("js-output-nomringstiff"), val:false},
			creepModulus:{class:"input", obj: document.getElementById("js-outout-creepmod"), val:false},
			longTermYoungModulus:{class:"input", obj: document.getElementById("js-outout-longtermyoungmod"), val:false},
			longTermStiffness:{class:"input", obj: document.getElementById("js-outout-longtermstiff"), val:false},
			SN:{class:"input", obj: document.getElementById("js-output-sSN"), val:false}
