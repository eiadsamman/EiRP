...
<div
	style="padding:20px 0px 10px 0px;min-width:300px;max-width:800px;background-color: #fff;position: sticky;top:43px;z-index: 50;">
	...
	<?php if (isset($modify_user) && $modify_user->loaded) { ?>
		<form id="FormInfoModify">
			...
			<div style="margin-top:0px;margin-bottom:5px;">
				...
				<div class="btn-set"
					style="position: sticky;top:103px;z-index: 4;padding-top:15px;padding-bottom:0px;background-color:#fff">
		...
		<form id="FormCompanyModify">
			...
			<div style="margin-top:0px;margin-bottom:5px;">
				...
				<div class="btn-set"
					style="position: sticky;top:103px;z-index: 3;padding-top:15px;padding-bottom:0px;background-color:#fff">
		...
		<form id="FormCostCenter">
			...
			<div style="margin-top:0px;margin-bottom:5px;">
				...
				<div class="btn-set"
					style="position: sticky;top:103px;z-index: 2;padding-top:15px;padding-bottom:0px;background-color:#fff">
		...
		<form id="FormAccountModify">
			...
			<div style="margin-top:0px;margin-bottom:5px;">
				<div class="btn-set"
					style="position: sticky;top:103px;z-index: 1;padding-top:15px;padding-bottom:0px;background-color:#fff">
