...
<thead>
	<tr><td align="center">طلب إجازة<br />Absence Request</td></tr>
</thead>
<tbody>
	<tr>
		<td>
			<div class="detailed_row">
				<div class="detailed_col">
					<span>Employee Name</span><span class="stretch"></span><div><?php echo $abs['empname'];?></div><span>اسم الموظف</span>
				</div>
				<div class="gap"></div>
				<div class="detailed_col" style="min-width:33%;max-width:33%">
					<span>No.</span><span class="stretch"></span><div><?php echo $abs['usr_id'];?></div><span>رقم الموظف</span>
				</div>
			</div>
		</td>
	</tr>
	<tr>
		<td>
			<div class="detailed_row">
				<div class="detailed_col">
					<span>Issue date</span><span class="stretch"></span><div style="min-width:130px;"><?php echo date("Y-m-d H:i",$abs['lbr_abs_issue_date']);?></div><span>تاريخ التحرير</span>
				</div>
				<div class="gap"></div>
				<div class="detailed_col" style="min-width:33%;max-width:33%">
					<span>ID#</span><span class="stretch"></span><div>AR<?php echo $abs['lbr_abs_id'];?></div><span>رقم الطلب</span>
				</div>
			</div>
		</td>
	</tr>
	<tr>
		<td>
			<div class="detailed_row">
				<div class="detailed_col">
					<span>First day of absence</span><span class="stretch"></span><div><?php echo date("Y-m-d",$abs['lbr_abs_start_date']);?></div><span>تاريخ بداية الإجازة</span>
				</div>
				<div class="gap"></div>
				<div class="detailed_col" style="min-width:33%;max-width:33%">
					<span>Reason</span><span class="stretch"></span><div><?php echo $abs['abs_typ_name'];?></div><span>سبب الإجازة</span>
				</div>
			</div>
		</td>
	</tr>
	<tr>
		<td>
			<div class="detailed_row">
				<div class="detailed_col">
					<span>Return to work date</span><span class="stretch"></span><div><?php echo $abs['returndate'];?></div><span>تاريخ العودة للعمل</span>
				</div>
				<div class="gap"></div>
				<div class="detailed_col" style="min-width:33%;max-width:33%">
					<span>Days</span><span class="stretch"></span><div style="min-width:130px;"><?php echo $abs['lbr_abs_days'];?></div><span>أيام الإجازة</span>
				</div>
			</div>
		</td>
	</tr>
	...
	<tr>
		<td>
			<div class="detailed_row">
				<div class="detailed_col">
					<span>Comments</span><span class="stretch"></span><div><?php echo $abs['lbr_abs_comments'];?></div>
				</div>
	...
	<tr>
		<td>
			<div class="detailed_row" style="height:120px;">
				<div class="detailed_col">
					<span>&nbsp;</span><div>مقدم الطلب<br /><?php echo $abs['empname'];?></div>
				</div>
				<div class="gap"></div>
				<div class="detailed_col" style="min-width:33%;max-width:33%">
					<span>&nbsp;</span><div>محرر الطلب<br /><?php echo $abs['signername'];?></div>
				</div>
				<div class="gap"></div>
				<div class="detailed_col" style="min-width:33%;max-width:33%">
					<span>&nbsp;</span><div>المسؤول المشرف<br /><?php echo "";?></div>
				</div>
			</div>
		</td>
	</tr>
