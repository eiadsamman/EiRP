...
<form id="jQpostForm">
			...
			<table class="bom-table">
				<tbody>
					<tr>
						...
						<td width="100%">
							<div class="btn-set"><input class="flex" name="fieldCurFrom" value="" data-slo="CURRENCY" type="text" id="jQinputFrom" /></div>
						</td>
					</tr>
				</tbody>
			</table>
	...
	<div style="background-color:#fff">
		...
		<div style="padding-left:10px;margin-top:10px;max-width:800px;">
			<table class="bom-table hover">
				<tbody id="jQtableSellCurrencies"></tbody>
			</table>
		</div>
