...
if ($app->xhttp) {
	...
	$grem->header()->prev("href=\"{$fs(209)->dir}\" data-href=\"{$fs(209)->dir}\"")->serve("
	...
	echo <<<HTML
		<form action="{$fs(209)->dir}" id="searchForm" style="max-width:500px">
			<div class="form">
				<label>
					<h1>Customer</h1>
					<div class="btn-set">
			...
			<div class="form" style="margin-top: 30px">
				<label for="">
					<div class="btn-set">
						<button type="submit" tabindex="8">Search</button><input type="button" class="edge-right" value="Cancel" data-href="{$fs(209)->dir}" />
					</div>
				</label>
			</div>
		</form>
