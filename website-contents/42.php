...
<table class="bom-table">
	<thead>
		...
		<tr>
			<td style="color:#333;">
				<div class="btn-set"><span>By name</span><input type="text" data-slo="E005" id="employee" style="-webkit-box-flex: 1;-moz-box-flex: 1;-webkit-flex: 1;-ms-flex: 1;flex: 1;max-width:300px;min-width:200px" /></div>
			</td>
		</tr>
		<!--<tr>
		...
		<tr>
			<td style="color:#333;">
				<div class="btn-set"><span>Get random non-verified serials</span><input type="text" id="jQmanualVal" style="width:80px;" value="10" /><button id="jQmanualBtn">Add serial</button></div>
			</td>
		</tr>
		<tr>
			<td style="color:#333;">
				<div class="btn-set"><span>ID range</span><input type="text" id="jQrangeFrom" style="width:80px;" value="0" /><span>To</span><input type="text" id="jQrangeTo" style="width:80px;" value="0" /><button id="jQrangeBtn">Add serial</button></div>
			</td>
		</tr>
		</tbody>
</table>
...
<form action="<?php echo $fs(28)->dir; ?>" target="_blank" method="post">
	<table class="bom-table hover">
		...
		<tbody>
			<tr>
				<th colspan="5" style="width:100px;color:#333;">
					<div class="btn-set noselect" style="justify-content:center"><span><label><input type="checkbox" value="1" name="verified" /> <span style="display:inline-block;vertical-align:text-bottom">Print verified</span></label></span><button type="submit">Print Serial</button></div>
				</th>
			</tr>
		</tbody>
	</table>
