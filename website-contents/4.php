...
function getbeidet(&$app,$id)
{
	$output = array();
	if ($r = $app->db->query("SELECT bom_sno,bom_beipn,bom_sapno,bom_sapdesc,bom_unit,bom_mattype FROM data WHERE bom_id='" . ((int)$id) . "';")) {
